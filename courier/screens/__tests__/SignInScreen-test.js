...
const mocks = [
  {
    ...
    result: {
      data: {
        signIn: {
          token:
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxMzYzOTc0YjZmMjZjNmNkNzg4MTE4MyIsImlhdCI6MTYzMTEyNTg4MSwiZXhwIjoxNjMzNzE3ODgxfQ.QlAWUoJ6z-40MS2GtDsbc9btN98Lxb_Nd4Z4I3DPGEA',
          user: {
...
it('handles valid input submission', async () => {
  ...
  const { getByTestId } = render(
    <MockedProvider mocks={mocks} addTypename={false}>
      <SignInScreen navigation={{ navigate: pushMock }} />
    </MockedProvider>
  );
